...
| Common error message | Mitigation/Resolution |
| ------------ | ------------- |
| *Certain regions do not support Data Warehouse provisioning. Please try another region. For more information, please contact Microsoft support. (Code: 45122, ResourceType: Microsoft.Sql/servers/databases, ResourceName: sqlservername)* | - Redeploy the solution with another region |
