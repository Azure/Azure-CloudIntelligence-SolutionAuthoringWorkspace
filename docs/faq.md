...
### ArmValidationFailed
This error code from CIQS indicates that ARM pre-flight validation fails. ARM pre-flight validation could fail for various reasons with different error codes: Some of them are actionable/retriable, such as [quota exceeded](#how-to-request-quota-increase); Some of them are non-recoverable; in this case, please [contact Azure support](#how-to-submit-azure-support-request) or [contact CIQS support](#how-to-contact-ciqs-support). Here is a list of known validation errors with corresponding recovery steps.

| Error code | Sample messages | Mitigation or resolution |
| -------- | ------------ | ------------- |
| <ul><li>*InvalidTemplate*<li>*InvalidTemplateDeployment*</li></li></ul> | <ul><li>*Deployment template validation failed: 'The template parameter 'sqldatasetName' is not found. Please see https://aka.ms/arm-template/#parameters for usage details.*</li><li>*Deployment failed with multiple errors: 'Authorization failed for template resource 'hostingdpshsyq7clvwy' of type 'Microsoft.Web/serverfarms'. The client 'xxxxx@xxx.com' with object id 'xxxxxxx-xxxx-xxxx-xxxx-xxxxxxxx' does not have permission to perform action 'Microsoft.Web/serverfarms/write' at scope '/subscriptions/xxxxxxx-xxxx-xxxx-xxxx-xxxxxxxx/resourceGroups/mlsmplgbk/providers/Microsoft.Web/serverfarms/hostingdpshsyq7clvwy'.:Authorization failed for template resource 'functions-dpshsyq7clvwy' of type 'Microsoft.Web/sites'. The client 'xxxxx@xxx.com' with object id 'xxxxxxx-xxxx-xxxx-xxxx-xxxxxxxx' does not have permission to perform action 'Microsoft.Web/sites/write' at scope '/subscriptions/xxxxxxx-xxxx-xxxx-xxxx-xxxxxxxx/resourceGroups/mlsmplgbk/providers/Microsoft.Web/sites/functions-dpshsyq7clvwy'.*</li></ul> | <ul><li>This usually suggests solution defects, please [contact CIQS support](#how-to-contact-ciqs-support)</li></ul> |
| <ul><li>*QuotaExceeded*</li><li>*MaxStorageAccountsCountPerSubscriptionExceeded*</li></ul> | <ul><li>*Operation results in exceeding quota limits of Core. Maximum allowed: 100, Current in use: 86, Additional requested: 18. Please read more about quota increase at http://aka.ms/corequotaincrease.*</li><li>*Subscription abcd1234-ef56-ghijklm78901 already contains 199 storage accounts and the maximum allowed is 200.*</li></ul> | <ul><li>If you are aware of the service type, you can delete some unused service from the Azure portal to release some quota</li><li>If you would like to increase the quota, you can follow the instructions to [request quota increase](#how-to-request-quota-increase). Once the quota is increased, you can [retry the provisioning step](#how-to-retry-a-failed-provisioning-step)</li><li>If the problem persists, please [contact CIQS support](#how-to-contact-ciqs-support)</li></ul> |
...
| *MarketplacePurchaseEligibilityFailed* | *Marketplace purchase eligibilty check returned errors. See inner errors for details. ","target":null,"details":[{"code":"BadRequest","message":"Offer with PublisherId: microsoft-ads, OfferId: windows-data-science-vm cannot be purchased due to validation errors. See details for more information.[{\"Marketplace is not available in your Subscription/Azure account's regions: VN. Please switch to an Azure account from an allowed region.\":\"StoreApi\"},{\"The Offer is not sold in the subscription/account region: VN\":\"StoreApi\"}]* | <ul><li>This usually suggests limitations for your subscription or Azure account. Please [contact your subscription admin](#how-to-contact-subscription-admin) for more details.</li><li>If the problem persists, please [contact Azure support](#how-to-submit-azure-support-request) or [contact CIQS support](#how-to-contact-ciqs-support)</li></ul> |
